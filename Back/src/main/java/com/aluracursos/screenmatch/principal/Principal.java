...
public class Principal {
    ...
    private final String API_KEY_OMDB = "&apikey=c2575eac";
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    4 - Buscar episodios por serie
                    5 - Top 5 Series
                    6 - Series por categoria
                    7 - Filtrar series por cant de temporadas y min de evaluacion
    ...
    private DatosSerie getDatosSerie() {
        ...
        var json = consumoApi.obtenerDatos(URL_BASE + nombreSerie.replace(" ", "+") + API_KEY_OMDB);
...
//        DatosSerie datosSerie = getDatosSerie();
        mostrarSeriesBuscadas();
        System.out.println("Escribe la serie que necesitas para ver episodios");
        var nombreSerie = teclado.nextLine();
        ...
        if (serie.isPresent()) {
            ...
            for (int i = 1; i <= serieEncontrada.getTotalTemporadas(); i++) {
                var json = consumoApi.obtenerDatos(URL_BASE + serieEncontrada.getTitulo().replace(" ", "+") + "&season=" + i + API_KEY_OMDB);
...
//                .collect(Collectors.toList());
    ...
    private void buscarEpisodiosPorTitulo(){
        ...
        episodiosEncontrados.forEach(e ->
                System.out.printf("Serie: %s Temporada %s Evaluación %s Evaluacion %s",
    ...
    private void top5EpisodiosPorSerie(){
        ...
        if (serieBuscada.isPresent()) {
            ...
            topEpisodios.forEach(e ->
                    System.out.printf("Serie: %s - Temporada %s - Nombre: %s - numEpisodio %s - Evaluacion %s \n",
